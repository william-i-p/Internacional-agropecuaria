...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210812_internacionalagropecuaria11_5e4c1cef976d9e3b5117_20210812022040_archive.zip';
	const ARCHIVE_SIZE		 = '64226131';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5e4c1ce-12022040';
    const SECONDARY_PACKAGE_HASH = '02c9180-12022040';
	const VERSION			 = '1.4.2';
