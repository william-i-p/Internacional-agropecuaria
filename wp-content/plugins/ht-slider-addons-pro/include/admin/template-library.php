...
if(!class_exists('HTSlider_Template_Library')){
    class HTSlider_Template_Library{
        ...
        public static $endpoint = HTSLIDER_PRO_PL_URL.'include/admin/json/layoutinfofree.json';
        ...
        function __construct(){
            ...
            self::$api_args = [
                'plugin_version' => HTSLIDER_PRO_VERSION,
                'url'            => home_url(),
            ];
        ...
        function admin_menu() {
            ...
            add_submenu_page(
                'htslider_page', 
                esc_html__( 'Templates Library', 'htslider-pro' ),
                esc_html__( 'Templates Library', 'htslider-pro' ), 
                'manage_options', 
                'htslider_templates', 
        ...
        public function scripts( $hook ) {
            ...
            if( 'ht-slider-pro_page_htslider_templates' == $hook ){
                ...
                // CSS
                wp_enqueue_style( 'htsltemplates-stapel', HTSLIDER_PRO_ADMIN_ASSETS . '/lib/css/stapel.css', false, HTSLIDER_PRO_VERSION );
                wp_enqueue_style( 'htsladmin', HTSLIDER_PRO_ADMIN_ASSETS . '/css/htslider-admin.css', false, HTSLIDER_PRO_VERSION );

                // JS
                wp_enqueue_script(
                    'htsltemplates-modernizr',
                    HTSLIDER_PRO_ADMIN_ASSETS . '/lib/js/modernizr.custom.63321.js',
                    [
                        'jquery',
                    ],
                    false
                ...
                wp_enqueue_script(
                    ...
                    HTSLIDER_PRO_ADMIN_ASSETS . '/lib/js/jquery.stapel.js',
                    [
                        'jquery',
                    ],
                    true
                ...
                wp_enqueue_script(
                    'htsltemplates-admin',
                    HTSLIDER_PRO_ADMIN_ASSETS . '/js/admin-ajax.js',
                    [
                        'jquery',
                    ],
                    true
            ...
            wp_localize_script(
                ...
                [
                    ...
                    'version'          => HTSLIDER_PRO_VERSION,
                    'pluginURL'        => plugin_dir_url( __FILE__ ),
                    'packagedesc'      => esc_html__( 'Templates in this package', 'htslider-pro' ),
                    'user'             => [
        ...
        function templates_ajax_request(){
            ...
            if ( ! current_user_can( 'manage_options') ) {
                echo json_encode(
                    array(
                        'message' => esc_html__( 'You are not permitted to import the template.', 'htslider-pro' )
                    )
                );
            }else{
                ...
                if ( isset( $_REQUEST ) ) {
                    ...
                    $defaulttitle = !empty( $response_data['title'] ) ? $response_data['title'] : esc_html__( 'New Template', 'htslider-pro' );
                    ...
                    echo json_encode(
                        array( 
                            'id' => $new_post_id,
                            'edittxt' => esc_html__( 'Edit Template', 'htslider-pro' )
                        )
                    );
