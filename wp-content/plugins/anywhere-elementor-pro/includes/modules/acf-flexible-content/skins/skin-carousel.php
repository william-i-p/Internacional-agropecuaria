...
class Skin_Carousel extends Skin_Base {
    protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/ae-acf-flexible-content/content/after_section_end', [ $this, 'carousel_controls' ] );
		add_action( 'elementor/element/ae-acf-flexible-content/layout_style/after_section_end', [ $this, 'register_style_controls' ] );
	}
	...
	public function render() {
		...
		$this->parent->add_render_attribute( 'outer-wrapper', 'class', 'ae-flexible-field-'.$flexible_field_name );

		if ($arrows_layout  === 'inside' ) {
		...
		$this->parent->add_render_attribute( 'acf-fc-list-wrapper', 'class', 'ae-acf-fc-widget-wrapper ae-swiper-wrapper swiper-wrapper' );	
		// Item Attribute
		$item_classes =  ['acf-fc-item', 'ae-post-item-' . $this->parent->get_id() , 'ae-swiper-slide', 'swiper-slide' ];
		//$item_inner_classes = [ 'ae-acf-fc-item-inner', 'ae-swiper-slide-wrapper', 'swiper-slide-wrapper'];
		$template = [];
			...
			<div <?php echo $this->parent->get_render_attribute_string( 'outer-wrapper' ); ?> >
				...
				<div <?php echo $this->parent->get_render_attribute_string( 'collection' ); ?> >
					...
					if( have_rows($flexible_field_name, $data) ):
						?>
						<div <?php echo $this->parent->get_render_attribute_string( 'acf-fc-list-wrapper' ); ?>>
						<?php
							while ( have_rows($flexible_field_name, $data) ) : the_row();
									$get_row_layout = get_row_layout();
									$this->parent->set_render_attribute( 'acf-fc-item', 'class', $item_classes );
									$this->parent->set_render_attribute( 'acf-fc-inner', 'class', ['ae-acf-fc-item-inner', 'ae-swiper-slide-wrapper', 'swiper-slide-wrapper', 'ae-layout-'.$get_row_layout]);
									if( $get_row_layout == array_key_exists($get_row_layout,$template)){
										?>
											<article <?php echo $this->parent->get_render_attribute_string( 'acf-fc-item' ); ?> >
												<div <?php echo $this->parent->get_render_attribute_string( 'acf-fc-inner' ); ?>>
					...
					<?php } ?>
					 <!-- Arrows Inside  -->
					<?php if ( $this->get_instance_value( 'navigation_button' ) === 'yes' && $this->get_instance_value( 'arrows_layout' ) === 'inside' ) { 
						$this->get_swiper_arrows();
					}?>
					<?php if ( $this->get_instance_value( 'scrollbar' ) === 'yes' ) {?>
	...
	public function get_swiper_arrows() {
		$arrow_Hpos = $this->get_instance_value( 'arrow_horizontal_position' );
		$arrow_layout = $this->get_instance_value('arrows_layout');
	...
	public function carousel_style_section() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ae-acf-fc-widget-wrapper' => 'margin-bottom:{{SIZE}}{{UNIT}};',
				],
				'condition' => [
					$this->get_control_id( 'ptype' ) => 'bullets',
				],
