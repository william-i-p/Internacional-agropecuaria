...
if (!class_exists('ElfsightPortfolioPlugin')) {
    class ElfsightPortfolioPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightPortfolioPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightPortfolioWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightPortfolioPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightPortfolioWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightPortfolioVCElement($config, $this->widgetsApi);
