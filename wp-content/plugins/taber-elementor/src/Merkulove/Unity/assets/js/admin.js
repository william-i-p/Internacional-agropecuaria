...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpTaberElementor = window.mdpTaberElementor;
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                ...
                nonce: mdpTaberElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpTaberElementor.ajaxURL, data, function( response ) {
