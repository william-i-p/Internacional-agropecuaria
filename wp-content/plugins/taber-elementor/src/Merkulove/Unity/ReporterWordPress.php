...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'taber-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'taber-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'taber-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'taber-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'taber-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'taber-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'taber-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'taber-elementor' ),
			'language'              => esc_html__( 'Language', 'taber-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'taber-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'taber-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'taber-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'taber-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'taber-elementor' ) : esc_html__( 'No', 'taber-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'taber-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'taber-elementor' ) : esc_html__( 'Inactive', 'taber-elementor' )
		];
