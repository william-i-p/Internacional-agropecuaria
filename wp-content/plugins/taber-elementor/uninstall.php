...
use Merkulove\TaberElementor\Unity\Cache;
use Merkulove\TaberElementor\Unity\Helper;
use Merkulove\TaberElementor\Unity\Plugin;
use Merkulove\TaberElementor\UninstallHelper;
use Merkulove\TaberElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_taber_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_taber_elementor_uninstall_settings' ] ) && $uninstall_settings[ 'mdp_taber_elementor_uninstall_settings' ] ) { // Default value.
            $uninstall_settings = [
